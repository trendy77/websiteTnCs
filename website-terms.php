...
<h3>Article 1. Definitions</h3>
    Organizemy Biz: Organizemy Biz is the supplier of the Services provided to the User.  User: the natural person or legal entity that is subject to these Terms & Conditions as a result of the use of the Website.
    ...
    Website: the website of OrganisemyBiz.com, referred to as "OrganisemyBiz" or under the umbrella title 'Trendy Publishing'.
	Terms & Conditions: the present terms and conditions.

<h3>Article 2. Applicability</h3>
    These Terms & Conditions apply to any use of the Website on the User's part.
    Unless explicitly agreed otherwise, the applicability of other terms & conditions is hereby excluded.

<h3>Article 3. Communication</h3>
    All communications between Organizemy Biz and the User will take place in electronic form.
    The version of each communication that Organizemy Biz receives or saves will serve as proof of that communication, unless the User submits proof to the contrary.

<h3>Article 4. Terms of use of the Service</h3>
    It is up to the User to decide what information will be saved and/or exchanged using the Service. Organizemy Biz has no knowledge of that information. As such, the User bears responsibility for ensuring that that information is lawful and does not infringe upon any third-party rights. Organizemy Biz cannot accept any liability for the information saved and/or exchanged using the Service. The User hereby indemnifies Organizemy Biz against any claims from third parties that are based on the position that the information saved and/or exchanged by the User using the Service is unlawful.
    In the event that Organizemy Biz is or becomes aware that the information saved and/or exchanged by the User using the Service is unlawful, Organizemy Biz will act without delay to remove that information or to block access to that information. Organizemy Biz reserves the right to remove or block the User's information in such an event, at Organizemy Biz's discretion. In no instance can Organizemy Biz be held liable for the damages resulting from such measures.
    The User agrees not to hinder other Users or Internet users or to damage the servers. The User may not start up any processes or programs, either on the server on which the Service runs or otherwise, of which the User is aware, or may reasonably expect, that they will hinder or cause damage to other Users or Internet users. Organizemy Biz will inform the User of any measures taken as a result.
    The User hereby indemnifies Organizemy Biz against all legal claims relating to the data, information, websites etc. stored by the User.
...
<h3>Article 5. Intellectual property rights</h3>
    The title to all intellectual property rights to all software made available and to all preparatory material belonging to such software remains exclusively to Organizemy Biz or its licensors. The User only acquires a non-exclusive and non-transferable right of use, as well as any rights explicitly granted pursuant to these Terms & Conditions or otherwise. The User may not reproduce or make copies of the Service or other materials.
    ...
    Organizemy Biz may take technical measures to protect the software for the Service. If Organizemy Biz has secured the software for the Service with technical security measures, the User may not remove or evade that security measure.
    The User retains the copyrights to his or her self-made movies and images.

<h3>Article 6. Liability</h3>
    Organizemy Biz cannot in any instant be held liable for indirect damages incurred by the User or third parties, including consequential damage, loss of turnover and profit, loss of data and intangible damage.
    Organizemy Biz's liability toward the User, on whatever grounds, is limited to the fees paid to Organizemy Biz by the User in the current calendar year (exclusive of VAT) per event (for which purpose a series of related events is deemed to constitute a single event).
    The User hereby indemnifies Organizemy Biz against all third-party claims, on whatever grounds, for compensation for damages, costs or interest relating to this Agreement and/or the Services.
    The previous items of this Article 6 do not apply if and insofar as the damages in question were caused by intent or wilful recklessness on the part of Organizemy Biz.

<h3>Article 7. Force Majeure</h3>
    In the event of force majeure, which is understood to include at least internal civil unrest, mobilisation, war, traffic obstructions, strikes, lockouts, interruption of operations, stagnation of supplies, fire, flooding and restrictions on imports and exports, and in the event that Organizemy Biz is rendered incapable of providing the Services by its own suppliers, regardless of the reasons for such, as a result of which Organizemy Biz cannot within reason be required to fulfil the Agreement, the implementation of the Agreement will be suspended, or else the Agreement will be terminated if the condition of force majeure lasts longer than four weeks. None of the situations outlined above will result in any liability to pay damages.

<h3>Article 8. Amendment of the Terms & Conditions</h3>
    Organizemy Biz reserves the right to amend or expand these Terms & Conditions.
    ...
    If the User does not wish to accept an amendment to these Terms & Conditions, he or she may, until the date on which the new Terms & Conditions enter into force, dissolve the Agreement with effect from that date or with effect from the date on which the notice of termination is received if that date is later than that on which the amendment takes effect.

<h3>Article 9. Final provisions</h3>
    These Terms & Conditions and the use of the Website are governed by the laws of the Netherlands.
...
<div>
 <nav>
  <ul>
  <li><a href="serviceTerms.php"><h5>Terms/Conditions - Website</h5></a></li>

 <li><a href="salesTerms.php">Terms/Conditions - Products</a></li>
...
<img src="../timg/TrendyPubFull.gif" alt="Trendy Publishing logo" 
...
<div class="foot-box foot-box-md col-md-2">
<img src="https://drive.google.com/open?id=0B92my6YeKTs9NHFYU29qamkybUE"  alt="Fake News Registry" 
...
<img src="https://drive.google.com/file/d/1yQ0ZRhHhlmhRlJxHau9Sp1drI-kgM82log/view?usp=sharing"  alt="GlobeTravelSearch"  title="GlobeTravelSearch.com" 
...
<img src="https://drive.google.com/open?id=0B92my6YeKTs9S1pvZ3FnOHo2c2c" alt="Govnews.info logo" 
...
<img src="https://drive.google.com/open?id=0B92my6YeKTs9ek5ucVd2cG1mc0U" alt="Custom Kits Worldwide Logo" 
 title="Custom Kits Worldwide - football news, team kit and jersey updates" 
class="alignright size-medium wp-image-3109" height="25" width="30"/>
</div><div class="foot-box foot-box-md col-md-7">
<img src="https://drive.google.com/open?id=0B92my6YeKTs9NDl0YkVjV0hmaWc" alt="outline" 
 title="Chairman of the Board1" class="alignright size-medium wp-image-3109" height="25" width="30"/>
</div>
<div class="foot-box foot-box-md col-md-8">
<img src="https://drive.google.com/file/d/0B92my6YeKTs9R2hrRHc2WXNjbG8/view?usp=sharing" alt="outline" 
 title="Chairman of the BoardOriginal" class="alignright size-medium wp-image-3109" height="25" width="30"/>
</div>
